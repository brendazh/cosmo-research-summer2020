...
color = ['crimson','dodgerblue', 'crimson','dodgerblue']
# color = ['r--','b-.','o','m--','k','c']
var_num = 2
...
legend_name= [r'$\Theta_i$ bestfit, high-$\ell$ TT,TE,EE',r'$\Theta_i=0.1$, high-$\ell$ TT',r'$\Theta_i=0.1$']
# legend_name= ['TT','TTTEEE',r'TT- $\theta_i=0.5$']
# legend_name= [r'$\theta_i$ free - TT',r'$\theta_i=0.1$ - TT']
# legend_name= [r'$\theta_i$ free',r'$\theta_i=3$']
alpha = [0.5,0.3,0.1]
...
for i in range(var_num):
    ...
    if i ==2:
        ...
        #         'scf_parameters' : '3,0',
    	# 		'scf_tuning_index':0,
        #         'log10_fraction_axion_ac':-1.4518,
        #         'log10_axion_ac':-4.052382e+00,
        #         'omega_cdm':1.221094e-01,
        #         'omega_b': 2.231871e-02,
        #         'H0':6.974940e+01 ,
        #         'tau_reio':7.274222e-02,
        #         'A_s':2.201364e-09,
        #         'n_s':9.853774e-01,
        ...
        # M.set({'scf_potential' : 'axion',
        #         'n_axion' : 3,
        #         'scf_parameters' : '2.806881e+00,0',
    	# 		'scf_tuning_index':0,
        #         'log10_fraction_axion_ac':-0.8589,
        #         'log10_axion_ac':-3.6195,
        #         'omega_cdm':1.328206e-01,
        #         'omega_b': 2.272357e-02,
        #         # '100*theta_s':1.0415,
        #         'h':7.243296e-01,
        #         'tau_reio':6.250161e-02,
        #         'A_s':2.173988e-09,
        #         'n_s':9.935683e-01,
    	# 		'scf_evolve_like_axionCAMB':'no',
    	# 		'do_shooting':'yes',
        ...
        # M.set({'scf_potential' : 'axion',
        #         'n_axion' : 2,
        #         'scf_parameters' : '2.234988e+00,0',
    	# 		'scf_tuning_index':0,
        #         'log10_fraction_axion_ac':-1.0443,
        #         'log10_axion_ac':-3.506125e+00,
        #         'omega_cdm':1.278275e-01,
        #         'omega_b': 2.219151e-02,
        #         # '100*theta_s':1.04119,
        #         'H0':7.114388e+01,
        #         'tau_reio':7.736808e-02 ,
        #         'A_s':2.225337e-09,
        #         'n_s':9.750557e-01,
    	# 		'scf_evolve_like_axionCAMB':'no',
    	# 		'do_shooting':'yes',
...
ax_TT_log.set_yticks(-0.08, -0.06, -0.04, -0.02, 0, 0.02, 0.04, 0.06, 0.08)
ax_TT_log.set_ylim((-0.12,0.12))

ax_EE_log.set_xscale('linear')
ax_EE_log.set_xlim((30,2500))
ax_EE_log.set_ylim((-0.12,0.12))
ax_EE_log.set_yticks(-0.08, -0.06, -0.04, -0.02, 0, 0.02, 0.04, 0.06, 0.08)
